...
4. **报告开头第一行必须是评分标题**，格式如下（不要添加任何前置文字、思考过程或寒暄语）：
   ```
   ## 📊 技术面评分：XX/100
   **评分解读**：80-100分代表技术面强势，60-80分代表技术面中性偏强，40-60分代表技术面中性，20-40分代表技术面偏弱，0-20分代表技术面弱势。评分基于均线系统、MACD、RSI、布林带等多维度技术指标的量化综合。
   ```
