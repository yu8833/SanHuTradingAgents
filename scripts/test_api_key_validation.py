...
def test_api_key_validation():
    ...
    test_cases = [
        ...
        ("sk-abc123def456ghi789jkl012mno345pqr", True, "有效的 API Key"),
        ("sk-stu678vwx901yza234bcd567efg890hij", True, "有效的 API Key"),
        ("AIzaSyYOUR_GOOGLE_API_KEY_HERE_EXAMPLE12", True, "有效的 Google API Key"),
        ("bce-v3/ALTAK-fakekey1234567890abcdef/fake1234567890abcdef1234567890abcdef12", True, "有效的千帆 API Key"),
        ("sk-or-v1-fake0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef", True, "有效的 OpenRouter API Key"),
        ('"sk-abc123def456ghi789jkl012mno345pqr"', True, "带引号的有效 API Key"),
        ("'sk-stu678vwx901yza234bcd567efg890hij'", True, "带单引号的有效 API Key"),
    ]
