      ...
      <el-tab-pane label="扫描结果" name="scan">
        <el-card class="result-panel" shadow="never">
          ...
          >
            ...
            <el-table-column prop="rise_from_low" label="距低点涨幅" width="120" sortable>
              <template #default="{ row }">
            ...
            <el-table-column prop="recent_20d_chg" label="近20日涨幅" width="120" sortable>
              <template #default="{ row }">
            ...
            <el-table-column prop="volume_change" label="成交量变化" width="120" sortable>
              <template #default="{ row }">
